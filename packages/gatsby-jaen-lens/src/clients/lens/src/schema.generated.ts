import {proxy, arrayProxy, fnProxy, t} from 'snek-query'
...
export class Mutation {
  __typename: t.String
  updateInternalPassword: (args: {password: t.String}) => UpdateInternalPassword
  serviceUpdate: (args: {
    id: t.String
  ...
  constructor() {
    this.__typename = ''
    this.updateInternalPassword = fnProxy(UpdateInternalPassword)
